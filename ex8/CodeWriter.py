...
def get_out_for_push_static(index,name):
    str_out = "@FUNC" + name +"$" + str(index) + "\n" + \
              "D=M\n" + \
              "@SP\n" + \
              "A=M\n" + \
              "M=D\n" + \
...
def get_out_for_pop_static(index, name):
    str_out = "@FUNC" + name +"$"+ str(index) + "\n" + \
              "D=A\n" + \
              "@R13\n" + \
              "M=D\n" + \
...
class CodeWriter:
    ...
    def write_push_pop(self, command: str, segment: str, index: int) -> None:
        ...
        if segment in segmentDictionary:
            ...
            if segment == "static":
                str_out = get_out_for_push_static(index,self.file_name)
            if segment == "pointer":
            ...
            if segment == 'static':
                str_out = get_out_for_pop_static(index ,self.file_name)
            if segment == 'pointer':
    ...
    def write_label(self, label: str) -> None:
        ...
        ## assume that the label command is always coming after function definition??
        # label_t =  self.cur_func + "$" + label
        label_t = self.file_name + "." + self.cur_func + "$" + label


        # label_t = self.file_name + "." + self.cur_func + "$" + label
        self.output_stream.write('(' + label_t + ')\n')
    ...
    def write_goto(self, label: str) -> None:
        ...
        cur_out = "@" + label_t + "\n" + \
                  "0; JMP\n"
        self.output_stream.write(cur_out)
    ...
    def write_if(self, label: str) -> None:
        ...
        # This is irrelevant for project 7,
        # you will implement this in project 8
        # checks what is binary val of sp
        # D = *SP
        # @ADDR
        # D; JNE
        label_t = self.file_name + "." + self.cur_func + "$" + label
    ...
    def write_function(self, function_name: str, n_vars: int) -> None:
        ...
        self.cur_func = function_name ## check
    ...
    def write_call(self, function_name: str, n_args: int) -> None:
        ...
        self.count+=1
        self.output_stream.write("@LABEL_RETURN"+function_name+"$"+str(self.count)+"\n")
        self.output_stream.write('D=A\n')
        self.output_stream.write('@SP\n')  #
        self.output_stream.write('A=M\n')  #
        self.output_stream.write('M=D\n')
        self.output_stream.write('@SP\n')
        self.output_stream.write('M=M+1\n')
        self._push_label_to_stack("LCL")
        self._push_label_to_stack("ARG")
        self._push_label_to_stack("THIS")
        self._push_label_to_stack("THAT")
    ...
    def write_return(self) -> None:
        ...
        self.output_stream.write('@LCL\n')  # LCL ---1
        self.output_stream.write('D=M\n')
        self.output_stream.write('@FRAME_RETURN\n')  # END-FRAME
        self.output_stream.write('M=D\n')
        ...
        self._return_label("THAT")
        self._return_label("THIS")
        self._return_label("ARG")
        self._return_label("LCL")
