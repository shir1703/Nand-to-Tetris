...
def translate_file(
    ...
    code_writer.output_stream.write("//******FFF"+code_writer.file_name+"\n")

    if bootstrap:
        code_writer.write_init()
    while parser.has_more_commands():
        parser.advance()
        line_type = parser.command_type()
...
"""
        if parser.command_type() == "C_ARITHMETIC":
            ...
            code_writer.write_function_commands("call", parser.arg1(),
                                                parser.arg2())
        elif parser.command_type() == "C_FUNCTION":
            code_writer.write_function_commands("function", parser.arg1(),
                                                parser.arg2())
        elif parser.command_type() == "C_RETURN":
            code_writer.write_function_commands("return", "", 0)
        elif parser.command_type() == "C_LABEL":
            code_writer.write_branching_commands("label", parser.arg1())
        elif parser.command_type() == "C_GOTO":
            code_writer.write_branching_commands("goto", parser.arg1())
        elif parser.command_type() == "C_IF":
            code_writer.write_branching_commands("if-goto", parser.arg1())

    code_writer.write_to_output_file_final()
"""
